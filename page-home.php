 ...
 <section class="section_2 py-5" id="services">
  ...
  <section class="section_3 py-5" id="workflow">
    <div class="container">
	  ...
	  <div class="tabwrap">
		  <div class="bunnyimg">
			 <?php if( isset( $_GET['theme_style'] ) == 'dark' ) { ?>
					  <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/bunnypeaking-white" alt="">
			  <?php
				  } 
				  else { 
			  ?>
					  <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/bunny-peaking-workflow.svg" alt="">
			  <?php
			  		}
			  ?> 
		  </div>
  ...
  <section class="stats section_5 py-5">
    <div class="container">
	  <h2 class="mb-5 text-uppercase"><?php echo esc_html( get_field('stats_heading') ); ?></h2>
      <div class="counter">
        <div class="row">
        <?php
            if( have_rows('stats') ) :
